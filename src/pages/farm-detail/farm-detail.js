...
*/
var FarmDetailPage = (function () {
    function FarmDetailPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.farm = navParams.get('farm');
    }
    FarmDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad FarmDetailPage');
    };
    return FarmDetailPage;
}());
FarmDetailPage = __decorate([
    Component({
...
//# sourceMappingURL=farm-detail.js.map